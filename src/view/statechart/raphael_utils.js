...
/*global red,esprima,able,uid,console,Map,window,Raphael */
...
(function (red) {
    ...
    (function (my) {
        ...
        proto.get_element = function () { return this._element; };
    ...
    (function (my) {
        ...
        proto.remove_child = function (child) {
            ...
            for (i = index; i < this.children.length; i += 1) {
        ...
        proto.update_subsequent_children = function (starting_index) {
            ...
            for (i = starting_index; i < this.children.length; i += 1) {
