					...
					env	
						...
						.cd("screen")
							...
							.cd("compound1")
								...
								.add_state("init")
								.add_state("clicked")
								.add_transition("init", "clicked", "mouse.click(this)")
								//on('click', this)")
								.add_transition("clicked", "init", "mouse.click(this)")
								//"on('click', this)")
								.start_at("init")
				...
				setup: function(env) {
					env	.set("obj", "<stateful>")
						.cd("obj")
							...
							.add_state("state1")
							.add_state("state2")
							.add_transition("state1", "state2", "mouse.down(this, preventDefault=true)")
