...
module("OBJ");
asyncTest('Basic objs', function() {
	var o1 = cjs.create("red_skeleton");
	...
	x_prop.set(a_state, cjs.create("red_cell", "1", x_prop.get_context()))
	x_prop.set(b_state, cjs.create("red_cell", "2", x_prop.get_context()))
	...
	cjs._.defer(function() {
		o2.get_statechart().run();
		equal(o2.get_prop("x").get(), 1);
		x_prop.unset(a_state)
		x_prop.set(a_state, cjs.create("red_cell", "3", x_prop.get_context()))
