...
var touches, last_time,
	...
	addCrossingPathListener("M0,0L300,300", function(velocity) {
		console.log(velocity);
	});
$(function() {
	var paper = Raphael(0, 0, 320, 200);
	var line1 = paper.path("M0,0L300,300");
	var touches;
	var time, dt, last_time;

	var set_touches = function(to_touches, type) {
	};

	$(window).on("touchstart touchmove touchend", function(event) {
		var e = event.originalEvent;
		set_touches(e.touches, event.type);
	});
});
